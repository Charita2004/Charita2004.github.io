...
namespace LoginRegistrationForm
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=LAPTOP-LB4HDG2U;Initial Catalog=user;Integrated Security=True;Encrypt=False");
        public Signup()
        {
            InitializeComponent();
        }
        ...
        private void signup_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (connect.State != ConnectionState.Open)
                {
                    ...
                    {
                        connect.Open();
                        String checkUsername = "SELECT * FROM Register WHERE username = '"
                        ...
                        using (SqlCommand checkUser = new SqlCommand(checkUsername, connect))
                        {
                            ...
                            {
                                string insertData = "INSERT INTO Register (email, username, password) " +
